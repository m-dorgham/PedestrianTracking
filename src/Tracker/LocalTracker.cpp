        ...
        )
{
    ...
    for (auto& track : tracks)
    {
        ...
        {
            track->m_averagePoint.x /= static_cast<track_t>(track->m_lastRegion.m_points.size());
            track->m_averagePoint.y /= static_cast<track_t>(track->m_lastRegion.m_points.size());
